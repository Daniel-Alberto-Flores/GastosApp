...
namespace PresentacionWF.Forms
{
    public partial class frmOutflowsPreload : Form
    {
		...
		private void BtnSaveClick(object sender, EventArgs e)
		{
			...
			string Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "BtnSaveClick");
		...
		private void FrmOutflowsPreloadFormClosed(object sender, FormClosedEventArgs e)
		{
			Exit();
		}
		...
		private void TranslateControls()
        {
			...
			Logica.Operations logicaOperations = new Logica.Operations();
			this.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "frmOutflowsPreload");
			gbxDaily.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "gbxDaily");
			gbxOthers.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "gbxOthers");
		}
