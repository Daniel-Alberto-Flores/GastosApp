...
namespace PresentacionWF.Forms
{
    public partial class frmAbout : Form
    {
        ...
        private void TranslateControls()
        {
            ...
            lblDeveloped.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblDeveloped");
            lblContact.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblContact");
            rtbInfo.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "rtbInfo");
