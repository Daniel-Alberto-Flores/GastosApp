...
namespace PresentacionWF.Forms
{
    public partial class frmIncomes : Form
    {
        ...
        private void BtnIncRemoveClick(object sender, EventArgs e)
        {
            ...
            {
                Logica.Operations logicaOperations = new Logica.Operations();        
                string Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "BtnIncRemoveClick");
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    {
                        Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "BtnIncRemoveNotExist");
        ...
        {            
            ...
            if (verifyStr && (dotCount < 2))
            {
                ...
                {
                    Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "BtnIncSaveEnterAmount");
                    MessageBox.Show(Message, "Info", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
            }
            else
            {
                Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "BtnIncSaveWrongValue");
                MessageBox.Show(Message, "Info", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                txtIncAmount.Focus();
            }
        }
        ...
        private void DgvListIncTypesCellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1)
            {
                ...
                {
                    Logica.Operations logicaOperations = new Logica.Operations();
                    string Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "ExistingIncome");
                    MessageBox.Show(Message, "Info", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
                else
                {
        ...
        private void BtnIncTypesRemoveClick(object sender, EventArgs e)
        {
            ...
            {
                Logica.Operations logicaOperations = new Logica.Operations();
                string Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "BtnIncTypesRemoveClick");
                DialogResult result = MessageBox.Show($"{Message} {Income}", "Info", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (result == DialogResult.Yes)
                {
        ...
        private void BtnIncTypesSaveClick(object sender, EventArgs e)
        {
            ...
            if (txtIncNewType.Text.Trim().Length <= 14)
            {
                if (txtIncNewType.Text.Trim() != "")
                {
                    ...
                    {
                        Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "IncomeAlreadyLoaded");
        ...
        private void TranslateControls()
        {
            ...
            Logica.Operations logicaOperations = new Logica.Operations();
            this.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "frmIncomes");
            btnReturn.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "btnReturn");
            gbxListInc.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "gbxListInc");
            gbxCalculatorInc.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "gbxCalculatorInc");
            lblInc.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblInc");
            lblIncName.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblIncName");
            lblIncAmount.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblIncAmount");
            lblIncValue.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblIncValue");
            gbxIncTypes.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "gbxIncTypes");
            lblIncTypeNewName.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblIncTypeNewName");
