...
namespace PresentacionWF.Forms
{
    public partial class frmNotes : Form
    {
        ...
        private void FrmNotesFormClosed(object sender, FormClosedEventArgs e)
        {
            Exit();            
        }
        ...
        private void TranslateControls()
        {
            ...
            this.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "frmNotes");
        }
        ...
        private void IniNotes()
        {
            ...
            {
                Logica.Operations logicaOperations = new Logica.Operations();
                string Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "IniNotes");
