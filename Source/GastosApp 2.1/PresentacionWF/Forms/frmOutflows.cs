    ...
    public partial class frmOutflows : Form
    {
        ...
        private void BtnRemoveClickFilter(object sender, EventArgs e)
        {
            if (Outflow != "")
            {
                ...
                string Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "BtnOutRemoveClick");
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    {
                        Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "BtnOutRemoveNotExist");
        ...
        private void BtnOutSaveClick(object sender, EventArgs e)
        {
            ...
            if (verifyStr && (dotCount < 2))
            {
                ...
                {
                    Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "BtnOutSaveEnterAmount");
                    MessageBox.Show(Message, "Info", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }                    
            }
            else
            {
                Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "BtnOutSaveWrongValue");
                MessageBox.Show(Message, "Info", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                txtOutAmount.Focus();
            }
        }
        ...
        private void DgvListOutTypesDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1)
            {
                ...
                {
                    Logica.Operations logicaOperations = new Logica.Operations();
                    string Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "ExistingOutflow");
                    MessageBox.Show(Message, "Info", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
                else
                {
        ...
        private void BtnOutTypesRemoveClick(object sender, EventArgs e)
        {
            ...
            {
                Logica.Operations logicaOperations = new Logica.Operations();
                string Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "BtnOutTypesRemoveClick");
                DialogResult result = MessageBox.Show($"{Message} {Outflow}", "Info", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (result == DialogResult.Yes)
                {
        ...
        private void BtnOutTypesSaveClick(object sender, EventArgs e)
        {
            ...
            if (txtOutNewType.Text.Trim().Length <= 14)
            {
                ...
                if (txtOutNewType.Text.Trim() != "")
                {
                    ...
                    {
                        Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "OutflowAlreadyLoaded");
                ...
                {
                    Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "CompleteFieldName");
                    MessageBox.Show(Message, "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            else
            {
                Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "LengthNameInvalid");
                MessageBox.Show(Message, "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }            
        }
        ...
        private void TranslateControls()
        {
            ...
            Logica.Operations logicaOperations = new Logica.Operations();
            this.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "frmOutflows");
            btnReturn.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "btnReturn");
            gbxListOut.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "gbxListOut");
            lblOutDaily.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblOutDaily");
            lblOutOthers.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblOutOthers");
            gbxCalculatorOut.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "gbxCalculatorOut");
            lblOut.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblOut");
            lblOutName.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblOutName");
            lblOutAmount.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblOutAmount");
            lblOutValue.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblOutValue");
            gbxOutTypes.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "gbxOutTypes");
            lblOutTypeNewName.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblOutTypeNewName");
            lblOutTypeDaily.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblOutTypeDaily");
            lblBalance.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblBalance");
        ...
        private void UpdateDgv()
        {
            if (ActiveForm != null)
            {
                ...
                {
                    Logica.Operations logicaOperations = new Logica.Operations();
                    string Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "UpdateDgv");
