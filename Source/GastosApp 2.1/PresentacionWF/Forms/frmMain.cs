...
namespace PresentacionWF.Forms
{
    public partial class frmMain : Form
    {
        ...
        private void BtnLanguageSaveClick(object sender, EventArgs e)
        {
            ...
            string Message = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Message", "LanguageUpdated");
        ...
        {
            Logica.Operations logicaOperations = new Logica.Operations();
            btnOutflows.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "btnOutflows");
            btnIncomes.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "btnIncomes");
            btnNotes.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "btnNotes");
            btnHelp.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "btnHelp");
            btnAbout.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "btnAbout");
            lblLanguage.Text = logicaOperations.LanguageFilter(Configurations.Language, this.Name, "Control", "lblLanguage");
